...
macro_rules! bytevec_impls {
    {$(impl $name:ident {$($field:ident : $t:ty),*})*} => {
        $(
            impl $crate::bytevec::ByteEncodable for $name
            {
                fn get_size<Size>(&self) -> Option<Size>
                    where Size: $crate::bytevec::BVSize + $crate::bytevec::ByteEncodable
                {
                ...
                fn encode<Size>(&self) -> $crate::bytevec::BVEncodeResult<Vec<u8>>
                    where Size: $crate::bytevec::BVSize + $crate::bytevec::ByteEncodable
                {
                    if self.get_size::<Size>().is_some() {
                        ...
                        Err($crate::bytevec::errors::ByteVecError::OverflowError)
                    }
                }
            }

            #[allow(dead_code, unused_assignments)]
            impl $crate::bytevec::ByteDecodable for $name {
                fn decode<Size>(bytes: &[u8]) -> $crate::bytevec::BVDecodeResult<$name>
                    where Size: $crate::bytevec::BVSize + $crate::bytevec::ByteDecodable
                {
                    let mut index = 0;
                    ...
                    $(
                        if bytes[index..].len() >= Size::get_size_of().as_usize() {
                            ...
                            return Err($crate::bytevec::errors::ByteVecError::BadSizeDecodeError {
                                expected: $crate::bytevec::errors::BVExpectedSize::MoreThan(
                    ...
                    if body_size == bytes[index..].len() {
                        Ok($name {
                            $(
                                $field: {
                                    ...
                                    let field = <$t as $crate::bytevec::ByteDecodable>::decode::<Size>(
                        ...
                        Err($crate::bytevec::errors::ByteVecError::BadSizeDecodeError {
                            expected: $crate::bytevec::errors::BVExpectedSize::EqualTo(
